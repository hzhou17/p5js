...
function preload() 
{
	...
	// image = new myImage()
	// images.push(dragon_img)	

	img = loadImage('assets/koi.png')





	//image = loadImage('assets/dragon.png')
...
function setup()
{
	...
	myImg = new myImage(img.width, img.height, img.pixels)
	...
	// 		{
	// 			let index = x + y * i.width

	// 			print(index)
	// 			let c = i.pixels[index*4]
	// 			let b = brightness([c])
	...
	// 			if (b < 1) 
	// 			{
	// 				i.spots.push(createVector(x, y))
	// 			}
	// 		}
	// 	}
	// }

	// print(images[0].spots.length)


	// for (let i of images[0].spots)
	// {
	// 	ellipse(i.x, i.y, 5)
